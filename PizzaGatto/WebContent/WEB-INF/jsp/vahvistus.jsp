            ...
            <c:forEach items="${tilRivit}" var="tilRivit"> <!--doGet-metodi-->             
                    <c:set var="counter" value="${counter + 1}"/>
                            	...
                            	<tr>
                                    ...
                                    <td><c:out value="${tuotteet.nimi}"/></td>
                                    <td><c:out value="${tilRivit.kpl}"/>kpl</td>                     <%-- Tässä on kappalemäärä tuotteelle. --%>
                                    <td><c:out value="${tilRivit.kokonaishinta}"/>€</td>     <%-- Tässä on kokonaishinta tuotteelle. --%>
                            	</tr>
    ...
    <form>
 	<input type="submit" class="tilausnappi" value="takaisin" onclick="form.action='Tilaa';">
 	<input type="submit" class="tilausnappi" name="action" value="vahvista" onclick="form.action='Etusivu';">
	</form>
